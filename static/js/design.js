...
$(document).ready(function(){
     ...
     $(".sample-box").not(":last-child").on("click", function(){
          if($(this).hasClass("bg-hot")){
               $(this).removeClass("bg-hot")
               $(this).addClass("bg-not-hot")
          }else{
     ...
     $(".sample-box.add").on("click", function(){
          $(this).parent().children().not(":last-child").last().after("<div class='sample-box bg-not-hot'><p class='active'>-</p></div>")
          $(this).parent().children().not(":last-child").last().on("click", function(){
               if($(this).hasClass("bg-hot")){
                    $(this).removeClass("bg-hot")
                    $(this).addClass("bg-not-hot")
               }else{
          ...
          $(this).parent().children().not(":last-child").last().children().on("click", function(e){
               e.stopPropagation()
               $(this).parent().remove()
          })
     })
